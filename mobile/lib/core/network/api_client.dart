...
class ApiClient {
  static final MockApiHandler? _sharedMockHandler =
      Env.useMockData ? MockApiHandler() : null;

  late final Dio dio;
  final MockApiHandler? _mockHandler = _sharedMockHandler;
  ...
  Future<Response> get(String path,
    ...
    if (_mockHandler != null) {
      return _mockHandler!
          .handle(method: 'GET', path: path, queryParameters: queryParameters);
    }
