...
class DashboardScreenState extends State<DashboardScreen> {
  ...
  Map<String, dynamic> _jarsStatus = {};
      ...
      builder: (context, _) {
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            actions: [
              IconButton(
                icon: Icon(Icons.notifications_active_outlined, color: BrutalColors.ink),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    BrutalCard(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            'Tổng số dư khả dụng',
                            style: BrutalStyles.bodyStyle(size: 14, color: BrutalColors.ink, weight: FontWeight.w700),
                          ),
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        ...
                                        Text('Thu nhập', style: BrutalStyles.labelStyle(size: 12, color: BrutalColors.ink)),
                                      ],
                                    ),
                                    Text(
                                      _formatCurrency(_monthlyIncome),
                                      style: BrutalStyles.bodyStyle(size: 14, weight: FontWeight.w800),
                                    ),
                                  ],
                                ),
                              ),
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        Icon(Icons.arrow_downward, color: BrutalColors.destructive, size: 16),
                                        const SizedBox(width: 4),
                                        Text('Chi tiêu', style: BrutalStyles.labelStyle(size: 12, color: BrutalColors.ink)),
                                      ],
                                    ),
                                    Text(
                    ...
                    GridView.count(
                      ...
                      crossAxisSpacing: 12,
                      children: [
                        _buildQuickAction('Danh mục', Icons.category_outlined, BrutalColors.green, () {
                          context.push('/categories');
                        }),
                        _buildQuickAction('Mục tiêu', Icons.track_changes, BrutalColors.cardBg, () {
                          context.push('/goals');
                        }),
                        _buildQuickAction('Nhắc nhở', Icons.alarm, BrutalColors.purple, () {
                          context.push('/reminders');
                        }),
                        _buildQuickAction('Tài chính', Icons.account_balance_outlined, Colors.amber[200]!, () {
                          context.go('/wallet');
                        }),
                      ],
                    ),
                    ...
                    BrutalCard(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('Tỷ lệ chi tiêu', style: BrutalStyles.titleStyle(size: 16)),
                          const SizedBox(height: 12),
                          Row(
                            children: [
                              Expanded(
                                flex: _monthlyExpenses == 0 && _monthlyIncome == 0 ? 5 : (_monthlyExpenses / (_monthlyIncome + 0.1) * 100).clamp(0, 100).toInt(),
                                child: Container(
                                  height: 24,
                                  decoration: BoxDecoration(
                                    color: BrutalColors.destructive,
                                    border: Border(
                                      top: BorderSide(color: BrutalColors.ink, width: 2),
                                      bottom: BorderSide(color: BrutalColors.ink, width: 2),
                                      left: BorderSide(color: BrutalColors.ink, width: 2),
                                    ),
                                  ),
                                  child: const Center(
                                    child: Text('Đã chi', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 10)),
                                  ),
                                ),
                              ),
                              Expanded(
                                flex: _monthlyExpenses == 0 && _monthlyIncome == 0 ? 5 : (100 - (_monthlyExpenses / (_monthlyIncome + 0.1) * 100).clamp(0, 100)).toInt(),
                                child: Container(
                                  height: 24,
                                  decoration: BoxDecoration(
                                    ...
                                    border: Border(
                                      top: BorderSide(color: BrutalColors.ink, width: 2),
                                      bottom: BorderSide(color: BrutalColors.ink, width: 2),
                                      right: BorderSide(color: BrutalColors.ink, width: 2),
                                      left: BorderSide(color: BrutalColors.ink, width: 2),
                                    ),
                                  ),
                                  child: Center(
                                    child: Text('Còn lại', style: TextStyle(color: BrutalColors.ink, fontWeight: FontWeight.bold, fontSize: 10)),
                                  ),
                                ),
                              ),
                            ],
                          ...
                          Text(
                            ...
                            style: BrutalStyles.labelStyle(size: 12, color: BrutalColors.grey),
                          ),
                        ],
                      ),
                    ),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        TextButton(
                          ...
                          child: Text('Xem thêm', style: BrutalStyles.bodyStyle(size: 14, color: BrutalColors.purple)),
                        ),
                      ],
                    ),
                    const SizedBox(height: 8),
                    _recentTransactions.isEmpty
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            final amount = (tx['transactionsAmount'] ?? 0.0).toDouble();
